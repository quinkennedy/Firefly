...
//		{id:"bg", image:"scenery", tileh:30, tilew:30, tilerow:10, gapx:0, gapy:0}]
	...
	addImage:[["logo",actualURL("resources/logo.png")], // Images are loaded setting an alias and a file name. Can be full images, like the logo (load this ASAP, so will be shown during the loading screen)
		["sprites",actualURL("resources/cels.png")],
		["font",actualURL("resources/font.png")],
		["tiles",actualURL("resources/gfx-village.png")]], // ...or font set.
	...
	addTiles:[
		...
		{id:"peyes", image:"sprites", tileh:40,tilew:40, tilerow:9,gapx:0,gapy:40},
